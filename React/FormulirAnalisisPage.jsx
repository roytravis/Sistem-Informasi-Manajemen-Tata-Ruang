    ...
    <style>
        {`
            @media print {
                ...
                /* Page Break Control */
                fieldset { border: 1px solid #000 !important; margin-bottom: 10px !important; break-inside: avoid; }
                ...
                <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
                    ...
                    <fieldset className="border p-4 rounded-md">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 mt-2 text-sm p-2">
                            <p><strong className="font-medium text-gray-600 w-32 inline-block">Nama</strong>: {dataPelakuUMK.nama}</p>
                            <p><strong className="font-medium text-gray-600 w-32 inline-block">NIB</strong>: {dataPelakuUMK.nomor_identitas}</p>
                            <p><strong className="font-medium text-gray-600 w-32 inline-block">Telepon</strong>: {dataPelakuUMK.telepon}</p>
                            ...
                            <table className="min-w-full text-sm table-auto border-collapse">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <TableCell rowSpan={2} className="border-r"><InputWithUnit><ManualInput name="luas_digunakan_ketentuan_rtr" value={formData.luas_digunakan_ketentuan_rtr} onChange={handleChange} disabled={isReadOnly} /></InputWithUnit></TableCell>
