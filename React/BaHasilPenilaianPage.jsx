    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                // Prefill jika sudah pernah disimpan
                if (response.data.ba_hasil_penilaian) {
                    setKesimpulan({
                        validitas_kegiatan: response.data.ba_hasil_penilaian.validitas_kegiatan,
                        rekomendasi_lanjutan: response.data.ba_hasil_penilaian.rekomendasi_lanjutan
                    });
                }
            } catch (err) {
        ...
        <div className="bg-gray-100 min-h-screen pb-10">
            ...
            <div className="printable-area max-w-[21cm] mx-auto bg-white p-8 md:p-12 shadow-lg">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-sm mt-1">Nomor: {data.ba_hasil_penilaians?.nomor_ba || '................/BA-HP/......./.......'}</p>
                </div>
